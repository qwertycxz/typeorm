...
import type { BunPostgresConnectionCredentialsOptions } from "./BunPostgresConnectionCredentialsOptions"
...
export class BunPostgresDriver implements Driver {
     ...
     */
    supportedIsolationLevels = BunPostgresDriver.supportedIsolationLevels
    ...
    constructor(dataSource?: DataSource) {
        ...
        this.options = dataSource.options as BunPostgresDataSourceOptions
    ...
    protected async createPool(
        options: BunPostgresDataSourceOptions,
        credentials: BunPostgresConnectionCredentialsOptions,
    ): Promise<any> {
        const { logger } = this.dataSource
